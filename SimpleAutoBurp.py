...
try:
    ...
    print("Missing config.json file. Make sure the configuration file is in the same folder", sys.exc_info()[0])
    exit()
...
def execute_burp(site):
    cmd = burpConfigs["java"] + " -jar " + burpConfigs["javaagent"] + " --illegal-access=permit -Dfile.encoding=utf-8 -noverify -Xmx" + burpConfigs["memory"] + " -Djava.awt.headless=" \
